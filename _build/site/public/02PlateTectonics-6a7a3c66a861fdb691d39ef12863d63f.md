...
figclass: margin-caption
---
Animation of the basic idea of convection: an uneven heat source in a fluid causes rising material next to the heat and sinking material far from the heat. [Image source](https://en.wikipedia.org/wiki/Convection)
```
