...
---
Simulated spectral solar irradiance at the top of the atmosphere (ToA) and the Earth's surface. The different regions of the spectrum include: ultraviolet (UV), visible, near infrared (NIR), and shortwave infrared (SWIR). Incoming radiation absorbed, scattered, and reflected by atmospheric gases. [Image source](https://earth.gsfc.nasa.gov/climate/projects/solar-irradiance/science)
```
