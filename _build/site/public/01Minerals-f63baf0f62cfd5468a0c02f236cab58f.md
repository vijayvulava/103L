...
figclass: margin-caption
---
Different minerals may have different streaks. [Image source](https://en.wikipedia.org/wiki/Streak_(mineralogy))
```
...
```{figure} https://www.nps.gov/articles/images/Mohs_Scale2_1.jpg?maxwidth=1300&autorotate=false&quality=78&format=webp 
---
name: moh
figclass: margin-caption
---
Chart of Mohs Hardness Scale with minerals arranged in hardness from 1 to 10, also showing common items that correlate with the scale.  [Image source](https://www.nps.gov/articles/mohs-hardness-scale.htm?quot)
```
...
```{figure} https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Lipari-Obsidienne_%285%29.jpg/1280px-Lipari-Obsidienne_%285%29.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail
---
name: obsidian
figclass: margin-caption
---
Obsidian, a naturally formed volcanic glass, lacks cleavage plane and breaks unevenly as a conchoidal fracture. Quartz and olivine also rarely show cleavage and typically break into conchoidal fracture patterns.  [Image source](https://en.wikipedia.org/wiki/Conchoidal_fracture) 
```




```{figure} https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Galena_-_Huallanca%2C_Bologesi%2C_Ancash%2C_Peru.jpg/1280px-Galena_-_Huallanca%2C_Bologesi%2C_Ancash%2C_Peru.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail https://slcc.pressbooks.pub/app/uploads/sites/35/2021/12/03.64_galena_cleavage_Argentiferous_Galena-458851.jpg
---
name: galena
figclass: margin-caption
---
