...
name: globalmeantemp
---
Land-ocean temperature index, 1880 to present, with a base time 1951-1980. The solid black line is the global annual mean and the solid red line is the five-year Lowess smoothing. The blue uncertainty bars (95% confidence limit) account only for incomplete spatial sampling. The graph shows that Earth’s temperature is rising. [Image source](https://data.giss.nasa.gov/gistemp/graphs_v4/#)(https://slcc.pressbooks.pub/app/uploads/sites/35/2022/02/15_tempgraph-300x159.png)
```
