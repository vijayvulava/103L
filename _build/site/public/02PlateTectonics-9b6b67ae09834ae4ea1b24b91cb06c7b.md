...
```{figure} https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Alfred_Wegener_ca.1924-30.jpg/960px-Alfred_Wegener_ca.1924-30.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail https://slcc.pressbooks.pub/app/uploads/sites/35/2021/09/Alfred_Wegener_ca.1924-30-2.jpg
---
name: wegener
figclass: margin-caption
---
Wegener later in his life, ca. 1924-1930. [Image source](https://slcc.pressbooks.pub/app/uploads/sites/35/2021/09/Alfred_Wegener_ca.1924-30-2.jpg) 
```
...
```{figure} https://slcc.pressbooks.pub/app/uploads/sites/35/2021/09/Antonio_Snider-Pellegrini_Opening_of_the_Atlantic.jpg
---
name: snider-pellegrini
figclass: margin-caption
---
Snider-Pellegrini’s map showing the continental fit and separation, 1858. [Image source](https://slcc.pressbooks.pub/app/uploads/sites/35/2021/09/Antonio_Snider-Pellegrini_Opening_of_the_Atlantic.jpg)
```
...
```{figure} https://slcc.pressbooks.pub/app/uploads/sites/35/2021/12/Wegener_fossil_map.svg_.png
---
name: gondwana
figclass: margin-caption
---
Image showing fossils that connect the Gondwana continents (the southern continents of Pangea). [Image source](https://slcc.pressbooks.pub/app/uploads/sites/35/2021/12/Wegener_fossil_map.svg_.png)
```
...
```{figure} https://slcc.pressbooks.pub/app/uploads/sites/35/2021/09/Convection.gif
---
name: mechanism
figclass: margin-caption
---
Animation of the basic idea of convection: an uneven heat source in a fluid causes rising material next to the heat and sinking material far from the heat. [Image source](https://slcc.pressbooks.pub/app/uploads/sites/35/2021/09/Convection.gif)
```
...
```{figure} https://slcc.pressbooks.pub/app/uploads/sites/35/2021/09/Earth-cutaway-schematic-english.svg_-1.png
---
name: layers
figclass: margin-caption
---
The layers of the Earth. Physical layers include lithosphere and asthenosphere; chemical layers are crust, mantle, and core. [Image source](https://slcc.pressbooks.pub/app/uploads/sites/35/2021/09/Earth-cutaway-schematic-english.svg_-1.png)
```
...
```{figure} https://opengeology.org/textbook/wp-content/uploads/2017/03/MohoDepth-300x167.png
---
name: crust
figclass: margin-caption
---
The global map of the depth of the Moho. [Image source](https://opengeology.org/textbook/wp-content/uploads/2017/03/MohoDepth-300x167.png)
```
...
```{figure} https://opengeology.org/textbook/wp-content/uploads/2017/02/Iddingsite-300x225.jpg
---
name: mantle
figclass: margin-caption
---
This mantle peridotite xenolith containing olivine (green) is chemically weathering by hydrolysis and oxidation into the brown pseudo-mineral iddingsite, which is a complex of water, clay, and iron oxides. The more altered side of the rock has been exposed to the environment longer. [Image source](https://opengeology.org/textbook/wp-content/uploads/2017/02/Iddingsite-300x225.jpg)
```
...
```{figure} https://opengeology.org/textbook/wp-content/uploads/2016/07/02.2_TolucaMeteorite-300x225.jpg
---
name: core
figclass: margin-caption
---
A polished fragment of the iron-rich Toluca Meteorite, with an octahedral Widmanstätten Pattern. [Image source](https://opengeology.org/textbook/wp-content/uploads/2016/07/02.2_TolucaMeteorite-300x225.jpg)
```
...
```{figure} https://opengeology.org/textbook/wp-content/uploads/2016/07/Plates_tect2_en.svg_-300x205.png
---
name: plates
figclass: margin-caption
---
Map of the major plates and their motions along boundaries. [Image source](https://opengeology.org/textbook/wp-content/uploads/2016/07/Plates_tect2_en.svg_-300x205.png)
```
...
```{figure} https://opengeology.org/textbook/wp-content/uploads/2016/07/Earths_Inner_Layers_denoting_the_LAB-300x207.png
---
name: astheno
figclass: margin-caption
---
The lithosphere-asthenosphere boundary changes with certain tectonic situations. [Image source](https://opengeology.org/textbook/wp-content/uploads/2016/07/Earths_Inner_Layers_denoting_the_LAB-300x207.png)
```
...
```{figure} https://opengeology.org/textbook/wp-content/uploads/2016/07/Tectonic_plate_boundaries-768x425.png
---
name: boundaries
figclass: margin-caption
---
Schematic of plate boundary types. [Image source](https://opengeology.org/textbook/wp-content/uploads/2016/07/Tectonic_plate_boundaries-768x425.png)
```
...
figclass: margin-caption
---
Geologic provinces of Earth. Orogenies are labeled light blue. [Image source](https://opengeology.org/textbook/wp-content/uploads/2017/03/CratonGeolProv-300x159.jpg)
```
...
_[Video](http://emvc.geol.ucsb.edu/2_infopgs/IP1GTect/cSubduction.html) showing continental-oceanic subduction, causing volcanism. By Tanya Atwater and John Iwerks._
...
```{figure} https://opengeology.org/textbook/wp-content/uploads/2017/03/OceanContSub-300x177.gif
---
name: oceanic-subduction
figclass: margin-caption
---
Subduction of an oceanic plate beneath a continental plate, forming a trench and volcanic arc. [Image source](https://opengeology.org/textbook/wp-content/uploads/2017/03/OceanContSub-300x177.gif)
```
