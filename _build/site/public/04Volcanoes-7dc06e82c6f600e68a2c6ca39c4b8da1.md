...
```{figure} assets/Granite_Rosa_Porriño_-_es_(rotated).jpg https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Granite_Rosa_Porri%C3%B1o_-_es_%28rotated%29.jpg/1920px-Granite_Rosa_Porri%C3%B1o_-_es_%28rotated%29.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail
---
name: granite-texture
figclass: margin-caption
---
Granite is a classic coarse-grained (phaneritic) intrusive igneous rock. The different colors are unique minerals. The black colors are likely two or three different minerals. [Image source](https://en.wikipedia.org/wiki/Granite) 
```
...
```{figure} https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Basalt_12_%2848674276333%29.jpg/1280px-Basalt_12_%2848674276333%29.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail
---
name: basalt-texture
figclass: margin-caption
---
Basalt is a classic fine-grained extrusive igneous rock. This sample is mostly fine-grained groundmass with a few small green phenocrysts composed of olivine. [Image source](https://en.wikipedia.org/wiki/Basalt)
```
