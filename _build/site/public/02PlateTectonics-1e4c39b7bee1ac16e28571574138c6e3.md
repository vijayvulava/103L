...
```{figure} https://upload.wikimedia.org/wikipedia/commons/6/69/Antonio_Snider-Pellegrini_Opening_of_the_Atlantic.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail_unscaled
---
name: snider-pellegrini
figclass: margin-caption
---
Snider-Pellegrini’s map showing the continental fit and separation, 1858. [Image source](https://en.wikipedia.org/wiki/Antonio_Snider-Pellegrini) (https://slcc.pressbooks.pub/app/uploads/sites/35/2021/09/Antonio_Snider-Pellegrini_Opening_of_the_Atlantic.jpg)
```
