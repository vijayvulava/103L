...
In this lab, we will focus on learning about volcanoes and how the theory of plate tectonics helps us understand why they occur. We will also learn about two major types of volcanoes and the typical hazards associated with such volcanoes. Igneous rocks are associated with these volcanic environments; therefore, we will also learn about the most common types of igneous rocks in these environments.

## Learning Objectives

Students will learn and demonstrate their understanding of:
- Distinguish between shield and composite volcanoes based on morphology using height-to-width ratios.
- Define viscosity and relate it to magma composition and eruption style.
- Explain how silica content influences magma behavior.
- Describe fractional crystallization and its effect on magma composition.
- Predict eruption style and hazards based on magma properties.
- Classify igneous rocks by composition and texture and relate them to tectonic settings.
...
A volcano is any location where magma comes to the surface, or has done so within the past several million years. This can include eruptions on the ocean floor (or even underwater in a lake), called subaqueous eruptions, or on land, called subaerial eruptions. Not all volcanic eruptions produce the volcanic mountains with which we are familiar; in fact, most of Earth’s volcanism takes place along the spreading ridges on the sea floor and does not produce volcanic mountains at all—not even sea-floor mountains.

[_https://opentextbc.ca/physicalgeology2ed/chapter/4-3-types-of-volcanoes/_](https://opentextbc.ca/physicalgeology2ed/chapter/4-3-types-of-volcanoes/)
...
Composite volcanoes, like Mount St. Helens in Washington State, are almost all associated with subduction at convergent plate boundaries—either ocean-continent or ocean-ocean boundaries. They can extend up to several thousand meters beyond the surrounding terrain and, with slopes up to 30˚, can be up to about 20 km across.   At many such volcanoes, magma is stored in a magma chamber in the upper part of the crust. For example, at Mount St. Helens, there is evidence of a magma chamber approximately 1 kilometer wide that extends from about 6 km to 14 km below the surface. Systematic variations in the composition of volcanism over the past several thousand years at Mount St. Helens imply that the magma chamber is zoned, from more felsic at the top to more mafic at the bottom.

```{figure} https://d9-wret.s3.us-west-2.amazonaws.com/assets/palladium/production/s3fs-public/styles/full_width/public/thumbnails/image/mt-st-helens-38-yrs.png?itok=7in3JScv
---
name: mtsthelens
figclass: margin-caption
---
The north side of Mount St. Helens in southwestern Washington State, 2003. The large 1980 eruption reduced the volcano's height by 400 m, and a sector collapse removed a large part of the northern flank. Between 1980 and 1986, the slow eruption of more mafic, less viscous lava led to the formation of a dome within the crater. [Image source](https://www.usgs.gov/media/images/mount-st-helens-erupted-38-years-ago-may-18-1980) (https://opentextbc.ca/physicalgeology2ed/wp-content/uploads/sites/298/2019/08/msh-3.jpg)
```
...
All of the Hawaiian volcanoes are related to the mantle plume that currently lies beneath Mauna Loa, Kilauea, and Loihi. In this area, the Pacific Plate is moving northwest at a rate of about 7 centimeters (cm) per year. This means that the earlier-formed, now-extinct volcanoes have moved well away from the mantle plume. There is evidence of crustal magma chambers beneath all three active Hawaiian volcanoes. At Kilauea, the magma chamber appears to be several kilometers in diameter and is situated between 8 km and 11 km below the surface.

```{figure} https://opentextbc.ca/physicalgeology2ed/wp-content/uploads/sites/298/2019/08/Mauna-Kea.png
---
name: hawaii
figclass: margin-caption
---
The mantle plume beneath the volcanoes of the island of Hawaii. [Image source](https://opentextbc.ca/physicalgeology2ed/wp-content/uploads/sites/298/2019/08/Mauna-Kea.png)
```

[Text Source](https://opentextbc.ca/physicalgeology2ed/chapter/4-3-types-of-volcanoes/)
...
In this section, we will explore the properties of magma and how its mineral composition and physical properties may impact its behavior during volcanic eruptions. Magma can contain varying amounts of silica (SiO2) and dissolved gases (such as CO2, H2O, and H2S). These factors affect how magma erupts and the type of volcano it will form when it solidifies. Note that the amount of silica in magma and its viscosity are positively correlated. Magma can contain 1% to 10% dissolved gases, much like a soda contains dissolved CO2. 
...
[Text Source](https://slcc.pressbooks.pub/introgeology/chapter/4-igneous-processes-and-volcanoes/)

## Eruptions and Hazards

<div class="container">
<iframe src="https://www.youtube.com/embed/BCm6xTZj-vk"
frameborder="0" allowfullscreen class="video"></iframe>
</div>


<div class="container">
<iframe src="https://www.youtube.com/embed/69iUhlqFJFk"
frameborder="0" allowfullscreen class="video"></iframe>
</div>
...
The two main textures found in igneous rocks – coarse-grained (phaneritic) and fine-grained (aphanitic)- provide information about the volcanic history of the rock.

_Phaneritic_ textured rocks have large crystals (the rock is coarse-grained). These rocks formed from slow-cooling magma underground, allowing time for crystals to grow large.

_Aphanitic-textured rocks have small crystals (the rock is fine-grained) and appear uniform in_ color overall. These rocks formed from faster-cooling lava at Earth’s surface, so there was no time for the crystals to grow.

```{figure} https://slcc.pressbooks.pub/app/uploads/sites/35/2021/12/Fig-6.3-Granite-vs-Gneiss-e1495050932921-300x271.jpg
---
name: granite-texture
figclass: margin-caption
---
Granite is a classic coarse-grained (phaneritic) intrusive igneous rock. The different colors are unique minerals. The black colors are likely two or three different minerals. [Image source](https://slcc.pressbooks.pub/app/uploads/sites/35/2021/12/Fig-6.3-Granite-vs-Gneiss-e1495050932921-300x271.jpg)
```
...
```{figure} https://slcc.pressbooks.pub/app/uploads/sites/35/2021/12/IMG_2623-e1495051966958-284x300.jpg
---
name: basalt-texture
figclass: margin-caption
---
Basalt is a classic fine-grained extrusive igneous rock. This sample is mostly fine-grained groundmass with a few small green phenocrysts composed of olivine. [Image source](https://slcc.pressbooks.pub/app/uploads/sites/35/2021/12/IMG_2623-e1495051966958-284x300.jpg)
```
...
<div class="container">
<iframe src="https://www.youtube.com/embed/zEeL0J0PPyk"
frameborder="0" allowfullscreen class="video"></iframe>
</div>
