...
figclass: margin-caption
---
The continents are blocks of thick crust that are passengers on the tops of large tectonic plates (lithosphere) that move over a softer part of Earth’s mantle (asthenosphere). Earthquakes, mountain building and volcanic activity occur mostly at the boundaries of the moving plates. Only shallow earthquakes occur where plates diverge at mid-ocean ridges, whereas earthquakes extend to great depth where plates converge at subduction zones. [Image source](https://oceanexplorer.noaa.gov/ocean-fact/plate-boundaries/)
```
