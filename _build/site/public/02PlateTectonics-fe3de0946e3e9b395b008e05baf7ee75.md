...
figclass: margin-caption
---
Murnpeowie meteorite, an iron meteorite with regmaglypts (thumprint-like depressions), from ablation caused by aerodynamic heating during fall NWA 859 iron meteorite showing effects of atmospheric ablation. [Image source](https://en.wikipedia.org/wiki/Meteorite)
```
