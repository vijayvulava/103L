...
In this lab, we learn about the basic ideas behind climate change, common misconceptions, and the consequences of global change. Addressing global change requires collective efforts from individuals, communities, governments, and international communities. Sustainable development, conservation practices, renewable energy adoption, responsible land-use planning, and global cooperation on climate action and biodiversity conservation are crucial for mitigating the negative impacts of global change and promoting a more sustainable and resilient future.

## Learning Objectives

Students will learn and demonstrate their understanding of:
- Differentiate between climate and weather.
- Identify major factors that control global climate.
- Analyze trends in temperature, sea level, and cryosphere data.
- Interpret graphs and datasets related to climate change indicators.
- Evaluate sources and impacts of greenhouse gas emissions.
- Assess evidence supporting anthropogenic climate change.
- Predict potential environmental and societal consequences of climate change.
...
[Text Source](https://slcc.pressbooks.pub/introgeology/chapter/15-global-climate-change/)
...
```{figure} https://earth.gsfc.nasa.gov/sites/default/files/lab_climate/tsis-diagram_annotated.png
---
name: solarspectrum
figclass: margin-caption
---
Simulated spectral solar irradiance at the top of the atmosphere (ToA) and the Earth's surface. The different regions of the spectrum include: ultraviolet (UV), visible, near infrared (NIR), and shortwave infrared (SWIR). [Image source](https://earth.gsfc.nasa.gov/climate/projects/solar-irradiance/science)
```
...
```{figure} https://data.giss.nasa.gov/gistemp/graphs_v4/graph_data/Temperature_Anomalies_over_Land_and_over_Ocean/graph.png
---
name: globalmeantemp
---
Land-ocean temperature index, 1880 to present, with a base time 1951-1980. The solid black line is the global annual mean and the solid red line is the five-year Lowess smoothing. The blue uncertainty bars (95% confidence limit) account only for incomplete spatial sampling. The graph shows that Earth’s temperature is rising. [Image source](https://data.giss.nasa.gov/gistemp/graphs_v4/#)
```


### Carbon Dioxide 

Anthropogenic greenhouse gases, mostly carbon dioxide ($\ce{CO2}$), have increased since the industrial revolution when humans dramatically increased burning fossil fuels. These levels are unprecedented in the last 800,000-year Earth history as recorded in geologic sources such as ice cores. Carbon dioxide has increased by 40 percent since 1750, and the rate of increase has been the fastest during the last decade. For example, since 1750, 2040 gigatons of $\ce{CO2}$ have been added to the atmosphere; about 40 percent has remained in the atmosphere while the remaining 60 percent has been absorbed into the land by plants and soil or into the oceans. Indeed, during the lifetime of most young adults, the total atmospheric $\ce{CO2}$ has increased by 50 ppm, or 15 percent.

```{figure} https://scripps.ucsd.edu/bluemoon/co2_400/mlo_full_record.png
---
name: keelingcurve
---
The Keeling Curve is a daily record of global atmospheric carbon dioxide concentration maintained by Scripps Institution of Oceanography at UC San Diego. [Image source](https://keelingcurve.ucsd.edu/)
```
...
<div class="container">
<iframe src="https://www.youtube.com/embed/9X07X35FzUc"
frameborder="0" allowfullscreen class="video"></iframe>
</div>


```{figure} https://www.nasa.gov/wp-content/uploads/2024/03/arctic-nsidc-2024-plot.jpg https://slcc.pressbooks.pub/app/uploads/sites/35/2022/02/15.2_LandIceAntarctica.png
---
name: antarcticicemass
figclass: margin-caption
---
Decline of Antarctic ice mass from 2002 to 2016. [Image source](https://slcc.pressbooks.pub/app/uploads/sites/35/2022/02/15.2_LandIceAntarctica.png)
```

[Text Source](https://slcc.pressbooks.pub/introgeology/chapter/15-global-climate-change/)

<div class="container">
<iframe src="https://www.youtube.com/embed/Fw7GfNR5PLA"
frameborder="0" allowfullscreen class="video"></iframe>
</div>

### Rising Sea Level

Sea level is rising 3.4 millimeters (0.13 inches) per year and has risen 0.19 meters (7.4 inches) from 1901 to 2010. This is largely thought to be due to both glacier melt and thermal expansion of seawater. Thermal expansion means that as objects such as solids, liquids, and gases heat up, they expand in volume. 
...
[Text Source](https://science.nasa.gov/climate-change/effects/)