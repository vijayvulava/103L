...
```{figure} assets/Kilauea-eruption-nps.jpg
---
name: kilauea
figclass: margin-caption
---
Kīlauea erupting with Mauna Loa volcano in a distance. Fountains of lava erupting several hundred feet in the air on December 23, 2024.  [Image source](https://www.nps.gov/havo/index.htm)
```
...
In this section, we will explore the properties of magma and how its mineral composition and physical properties may impact its behavior during volcanic eruptions. Magma can contain varying amounts of silica ($\ce{SiO2}$) and dissolved gases (such as $\ce{CO2}$, $\ce{H2O}$, and $\ce{H2S}$). These factors affect how magma erupts and the type of volcano it will form when it solidifies. Note that the amount of silica in magma and its viscosity are positively correlated. Magma can contain 1% to 10% dissolved gases, much like a soda contains dissolved $\ce{CO2}$. 
...
```{figure} https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Granite_Rosa_Porri%C3%B1o_-_es_%28rotated%29.jpg/1920px-Granite_Rosa_Porri%C3%B1o_-_es_%28rotated%29.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail
---
name: granite-texture
figclass: margin-caption
---
Granite is a classic coarse-grained (phaneritic) intrusive igneous rock. The different colors are unique minerals. The black colors are likely two or three different minerals. [Image source](https://en.wikipedia.org/wiki/Granite) (https://slcc.pressbooks.pub/app/uploads/sites/35/2021/12/Fig-6.3-Granite-vs-Gneiss-e1495050932921-300x271.jpg)
```
