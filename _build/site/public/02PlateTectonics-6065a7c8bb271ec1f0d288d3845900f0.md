...
figclass: margin-caption
---
Earth’s outer shell is broken into tectonic plates that move relative to one another. The plates rip apart at divergent plate boundaries, crash together at convergent plate boundaries, and slide past each other at transform plate boundaries. [Image source](https://opengeology.org/textbook/wp-content/uploads/2016/07/Plates_tect2_en.svg_-300x205.png)
```
