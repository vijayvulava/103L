...
---
A wave-cut platform in bedded sedimentary rock on Gabriola Island, B.C. The wave-eroded surface is submerged at high tide. [Image source](https://opentextbc.ca/physicalgeology2ed/chapter/17-2-landforms-and-coastal-erosion/)
```
...
```{figure} assets/Provincetown_Spit_Cape_Cod.jpg
---
name: spit
figclass: margin-caption
---
Provincetown Spit, at the northern end of Cape Cod, was formed by longshore drift after the end of the last Ice age.  [Image source](https://en.wikipedia.org/wiki/Longshore_drift)
```
...
```{figure} assets/Tide_schematic.webp
---
name: tides
figclass: margin-caption
---
Relative orientation of sun, moon, and Earth resulting in tides of various magnitudes. [Image source](https://en.wikipedia.org/wiki/Tide)
```


```{figure} assets/Tide_type.webp
---
name: tidalphase
figclass: margin-caption
---
Distribution of tidal phases for different tidal types. [Image source](https://en.wikipedia.org/wiki/Tide)
```
