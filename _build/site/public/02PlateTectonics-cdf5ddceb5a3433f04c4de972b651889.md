...
```{figure} https://upload.wikimedia.org/wikipedia/commons/7/79/Murnpeowie_meteorite.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail_unscaled https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Oriented_Taza_Meteorite.jpg/1280px-Oriented_Taza_Meteorite.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail
---
name: core
figclass: margin-caption
---
NWA 859 iron meteorite showing effects of atmospheric ablation. [Image source](https://en.wikipedia.org/wiki/Meteorite)
```
