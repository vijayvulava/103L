...
- Evaluate evidence supporting continental drift. 
...
```{figure} https://www.nps.gov/npgallery/GetAsset/848af2a7-72fe-41e4-b69c-6c1f5c312776/proxy/hires?
---
name: pangea
figclass: margin-caption
---
Blocks of thick continental crust fit together nicely along the edges of their shelves to form the supercontinent called Pangea. [Image source](https://www.nps.gov/media/photo/gallery-item.htm?pg=6280190&id=29436df0-439c-46b4-8cab-0579fedec2ba&gid=4BBF72B6-3C5F-4F2E-AAC6-71D6AC2DE4C5)
```
...
```{figure} https://www.nps.gov/npgallery/GetAsset/71d6f747-66a3-43fc-8e94-639c04ea516c/proxy/hires?
---
...
```{figure} https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Mid-ocean_ridge_cut_away_view.png/1280px-Mid-ocean_ridge_cut_away_view.png?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail
---
name: mor
figclass: margin-caption
---
Mid-ocean ridge cross-section (cut-away view). [Image source](https://en.wikipedia.org/wiki/Mid-ocean_ridge)
```
...
```{figure} https://upload.wikimedia.org/wikipedia/commons/f/f5/Earth_seafloor_crust_age_1996_-_2.png?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail_unscaled
---
name: oceanic-lithosphere
figclass: margin-caption
---
Age of oceanic lithosphere, in millions of years. Notice the differences in the Atlantic Ocean along the coasts of the continents. [Image source](https://en.wikipedia.org/wiki/Mid-ocean_ridge)
```
...
```{figure} https://upload.wikimedia.org/wikipedia/commons/b/bb/Strike_slip_fault.png?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail_unscaled
---
name: strike-slip
figclass: margin-caption
---
...
```{figure} https://upload.wikimedia.org/wikipedia/commons/4/48/Piqiang_Fault%2C_China_detail.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail_unscaledhttps://upload.wikimedia.org/wikipedia/commons/4/48/Piqiang_Fault%2C_China_detail.jpg?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail_unscaled
---
name: piquiangfault
figclass: margin-caption
---
Satellite image of a fault in the Taklamakan Desert. The two colorful ridges (at bottom left and top right) used to form a single continuous line, but have been split apart by movement along the fault.   [Image source](https://en.wikipedia.org/wiki/Fault_(geology)#Strike-slip_faults)
```
